...
startButton.classList.add('btn', 'warning', 'col-md-3', 'col-md-offset-3');
...
resetButton.classList.add('btn', 'btn-warning', 'col-md-3', 'col-md-offset-3');
...
function startTimer(){
	...
	startButton.classList.remove('btn-warning', 'btn-success');
